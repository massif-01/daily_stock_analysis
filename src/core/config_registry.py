...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "LLM_USAGE_HMAC_SECRET": {
        ...
        "description": "Optional deployment-scoped secret for LLM usage telemetry prompt/message HMAC. Leave empty to use a local generated secret file.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
        ...
        "examples": [
            "LLM_USAGE_HMAC_SECRET=change-me-to-a-random-secret",
        ],
        "docs": [
            {
                "label": "LLM 配置指南",
