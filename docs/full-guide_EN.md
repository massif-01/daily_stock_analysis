...
| `GENERATION_BACKEND_MAX_OUTPUT_BYTES` | Total captured stdout/stderr plus final-response size limit for one local CLI backend call; range `1-33554432` | `1048576` | No |
